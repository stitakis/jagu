...
/**
 * Snippet which shows how to check if commits are merged into service
 * given branch. 
 * 
...
public class CheckMergeStatusOfCommit {
    ...
    public static void main(String[] args) throws IOException {
        ...
        // first service commit that was merged
        ...
        // then service commit on service test-branch which is not merged
